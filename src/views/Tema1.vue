...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5 Veamos este ejemplo de una compra si tenemos una estructura de tablas relacional que incluye la siguiente forma:
      ...
      .tarjetacolor-acento-botones--borde.p-4(titulo="<em>Dirty Read</em> <b>(Lectura sucia)</b>")
        ...
        .tabla-a.color-acento-contenido.mb-5.fblanco
          table
            ...
            tbody
              tr
                td <em>UPDATE</em> cuentas <em>SET</em> saldo = saldo - 300 <em>WHERE</em> id = 1;
                td
              tr
                td
                td <em>SELECT</em> saldo <em>FROM</em> cuentas <em>WHERE</em> id = 1;
              tr
                td <em>SELECT</em> saldo <em>FROM</em> cuentas <em>WHERE</em> id = 1;
                td
      .tarjetacolor-acento-botones--borde.p-4(titulo="<em>Non-Repeatable Read</em> <b>(Lectura No Repetible)</b>")
        ...
        .tabla-a.color-acento-contenido.mb-5.fblanco
          table
            ...
            tbody
              tr
                td <em>SELECT</em> saldo <em>FROM</em> cuenta <em>WHERE</em> id = 1;
                td
              tr
                td
                td <em>UPDATE</em> CUENTAS <em>SET</em> saldo = saldo - 200 <em>WHERE</em> id = 1;
              tr
                td <em>SELECT</em> saldo <em>FROM</em> cuentas <em>WHERE</em> id = 1;
                td
        ...
        .tabla-a.color-acento-contenido.mb-5.fblanco
          table
            ...
            tbody
              ...
              tr
                td
                td <em>INSERT INTO</em> cuentas <em>VALUE</em> (2, 9000);
              tr
                td <em>SELECT SUM</em> (saldos) <em>FROM</em> cuenta;
                td
    ...
    .row.justify-content-center.align-items-center
      .col-lg-6.mb-3.mb-lg-0
        .titulo-sexto.color-acento-contenido.mb-4(data-aos='fade-right')
          h5 Figura 1.
          span El código en consola de <em>Mysql</em>
        figure
          img.mb-3(src='@/assets/curso/temas/t1/f5.png', alt='La figura representa como debe aparecer el código en consola de Mysl, nos muestra el bloque de escritura.')
          p.tarjeta--gris.p-3 <b>Nota</b>: el gráfico representa como debe aparecer el código en consola de <em>MySQL</em>, nos muestra el bloque de escritura. Tomado de: 
    ...
    p.mb-5 Vamos a instalar un servidor de bases de datos <em>MySQL</em>, para ello tener en cuenta lo siguiente:
      ...
      .col-lg-7
        LineaTiempoD.color-acento-botones
          div(numero="1" titulo="Para conectar con bases de datos")
            ol.lista-ol
              li
                p.mb-0 <b>a</b>. Descargar e instalar el <em>appserv</em> (Ojo como el usuario será root pueden colocar <em>Password</em> root1234): 
                  a(href='https://sourceforge.net/projects/appserv/files/AppServ%20Open%20Project/8.5.0/appserv-win32-8.5.0.exe/download?use_mirror=gigenet&download=', target="_blank") descargar <em>AppServ</em>
              li
                p.mb-0 <b>b</b>. Ver video de instalación: 
          ...
          div(numero="4" titulo="Importante")
            p Es posible que <em>MySQLworkbench</em> le salga que no se puede instalar porque no tiene <em>Visual C++</em> entonces instalarlo.
            p
              a(href="https://www.youtube.com/watch?v=fBogDpofRiQ", target="_blank") https://www.youtube.com/watch?v=fBogDpofRiQ
    ...
    .row.justify-content-center.align-items-center.mb-3
      ...
      .col-lg-8
        AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta--gris")
          div(titulo="Seguridad física").ms-5
          ...
          div(titulo="Controles de acceso administrativo y de red").ms-5
          ...
          div(titulo="Seguridad de cuenta/dispositivo de usuario final").ms-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-8.order-lg-1
        AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta--gris")
          div(titulo="Seguridad de <em>software</em> de base de datos").ms-5
          ...
          div(titulo="Seguridad del servidor de aplicaciones/<em>web</em>").ms-5
          ...
          div(titulo="Seguridad de copia").ms-5
    ...
    .col-lg-10.mx-auto
      .tarjeta.color-primario.grbg1.p-4
        .row.justify-content-around.align-items-center
          .col-3.col-sm-2.col-lg-1.mb-3.mb-xl-0
            img(src="@/assets/curso/temas/t1/f11.svg")
          .col-auto
            .row.justify-content-between.align-items-center
              .col-auto.mb-3.mb-sm-0
                h4.mb-1 Proceso de instalación de <em>MongoDB</em>
                p.text-small Descargue el siguiente documento, el cual explica el proceso de instalación de <em>MongoDB</em>.
              .col.mb-3.mb-sm-0
